  ...
  return (
    <ServiceLayout>
      ...
      <section className="bg-gradient-to-br from-red-900 via-red-800 to-orange-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Shield className="w-20 h-20 mx-auto mb-6 text-red-300" />
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Cybersecurity & <span className="text-red-300">Ethical Hacking</span>
            </h1>
            <p className="text-xl text-red-100 max-w-3xl mx-auto mb-8">
              Protect your digital assets with our comprehensive cybersecurity solutions and ethical hacking services.
            </p>
            <button className="inline-flex items-center space-x-2 px-8 py-4 bg-red-600 text-white rounded-full font-semibold text-lg hover:bg-red-500 transition-all duration-300 hover:scale-105">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Comprehensive protection against modern cyber threats</p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Threats We Protect Against</h2>
            <p className="text-xl text-gray-600">Stay ahead of evolving cyber threats</p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {threats.map((threat) => (
              <div key={threat} className="bg-white p-4 rounded-lg text-center font-semibold text-gray-700 hover:shadow-md transition-all duration-300 hover:scale-105 border-l-4 border-red-500">
                {threat}
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">End-to-end security services for complete protection</p>
          </div>

          <div className="grid lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={service.title} className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 hover:shadow-lg transition-all duration-300">
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-4 bg-red-600 text-white rounded-full font-semibold hover:bg-red-500 transition-colors duration-300">
