      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            About <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Digitiq Technologies</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-2xl transform hover:scale-105 transition-all duration-300 hover:shadow-lg">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-2xl transform hover:scale-105 transition-all duration-300 hover:shadow-lg mt-8">
              ...
              <div className="space-y-6 mt-8">
                <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 p-6 rounded-2xl transform hover:scale-105 transition-all duration-300 hover:shadow-lg">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {stats.map((stat, index) => (
            <div
              key={stat.label}
              className="text-center p-8 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl transform hover:scale-105 transition-all duration-300 hover:shadow-lg"
